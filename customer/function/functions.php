            ...
            if (!isset($_GET['delete_account'])) {
                  ...
                  $count_orders = mysqli_num_rows($run_orders);
                    ...
                    if ($count_orders>0) {
                        ...
                        <div>
                        <h2 style='color:red;'><span class='badge badge-danger'>Important!</span></h2>
                        <h3>You have ($count_orders) pending orders</h3>
                        <h4>Please see your orders detail by clicking this <a href='my_account.php?my_orders' style='text-decoration:none;'>link</a><br>
                        Or you can <a href='pay_offline.php' style='text-decoration:none;' target='_blank'>Pay Offline Now</a> 
                        </h4>
                        </div>  
                        ";
                      ...
                      echo "
                        ...
                        <h4>You can see your order history by clicking this <a href='my_account.php?my_orders' style='text-decoration:none;'>link</a> 
                        </h4>
                        </div>  
                        ";
